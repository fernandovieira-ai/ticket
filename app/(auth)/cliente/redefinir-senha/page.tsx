          ...
          <div className="w-full max-w-[360px]">
            ...
            {sucesso ? (
              <div className="flex flex-col items-center gap-4 py-4 text-center">
                ...
                <Button className="mt-2 w-full h-11 bg-blue-600 hover:bg-blue-700" onClick={() => router.push('/cliente/login')}>
                  Ir para o login
                </Button>
              </div>
            ) : !token ? (
              <div className="flex flex-col items-center gap-4 py-4 text-center">
                ...
                <a href="/cliente/recuperar-senha" className="text-blue-600 text-sm font-medium hover:underline mt-2">
                  Solicitar novo link
                </a>
              </div>
            ) : (
